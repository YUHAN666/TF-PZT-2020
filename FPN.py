...
def bifpn_segmentation_head(features, num_channels, scope, is_training=False, reuse=None):
	...
	with tf.variable_scope(scope, reuse=reuse):
		...
		# upsample
		# P7_U = keras.layers.UpSampling2D(interpolation='bilinear')(P7_in)
		...
		# P6_U = keras.layers.UpSampling2D(interpolation='bilinear')(P6_td)
		...
		# P5_U = keras.layers.UpSampling2D(interpolation='bilinear')(P5_td)
		...
		# P4_U = keras.layers.UpSampling2D(interpolation='bilinear')(P4_td)
		...
		# downsample
		P3_D = keras.layers.MaxPooling2D(strides=(2, 2))(P3_out)
		...
		P4_D = keras.layers.MaxPooling2D(strides=(2, 2))(P4_out)
		...
		P5_D = keras.layers.MaxPooling2D(strides=(2, 2))(P5_out)
		...
		P6_D = keras.layers.MaxPooling2D(strides=(2, 2))(P6_out)
...
def fpn_segmentation_head(feature, class_num, drop_rate, keep_dropout_head,
